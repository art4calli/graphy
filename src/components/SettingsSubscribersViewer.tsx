                    ...
                    <tr 
                      ...
                      className={`transition-colors group ${
                        isAllowed
                          ...
                          : "bg-rose-50/50 dark:bg-rose-950/25 hover:bg-rose-100/60 dark:hover:bg-rose-900/40 border-r-4 border-r-rose-500"
                      }`}
                    >
                      {/* Row Index */}
                      ...
                      {/* 1. اسم المشترك + تمييز مسموح/ممنوع اللوني */}
                      <td className="py-3 px-4">
                        <div className="flex items-center gap-2.5">
                          ...
                          <div className="flex items-center gap-2 flex-wrap">
                            ...
                            {/* شارة حالة الدخول (مسموح / ممنوع) للتفريق اللوني الفوري مع إمكانية التبديل السريع */}
                            {isAllowed ? (
                              <button
                                type="button"
                                onClick={() => handleQuickToggleStatus(rec)}
                                className="inline-flex items-center gap-1 text-[10px] px-2 py-0.5 rounded-full font-bold bg-emerald-100/90 text-emerald-800 dark:bg-emerald-900/50 dark:text-emerald-300 border border-emerald-200 dark:border-emerald-800 shrink-0 hover:bg-emerald-200 dark:hover:bg-emerald-800/60 transition-colors cursor-pointer"
                                title="الحالة: مسموح (اضغط للتبديل السريع إلى ممنوع)"
                              >
                              ...
                              <button
                                type="button"
                                onClick={() => handleQuickToggleStatus(rec)}
                                className="inline-flex items-center gap-1 text-[10px] px-2 py-0.5 rounded-full font-bold bg-rose-100 text-rose-800 dark:bg-rose-900/60 dark:text-rose-200 border border-rose-300 dark:border-rose-800 shrink-0 hover:bg-rose-200 dark:hover:bg-rose-800/60 transition-colors cursor-pointer"
                                title="الحالة: ممنوع (اضغط للتبديل السريع إلى مسموح)"
                              >
                      ...
                      {/* 2. رقم التسجيل */}
                      <td className="py-3 px-4 font-mono text-xs text-slate-700 dark:text-slate-200 font-semibold">
                        <div className="flex items-center gap-1.5">
                          <span className={`px-2.5 py-1 rounded-md border ${
                            isAllowed
                              ? "bg-slate-100 dark:bg-slate-700/80 border-slate-200 dark:border-slate-600"
                              : "bg-rose-100/80 dark:bg-rose-900/40 text-rose-900 dark:text-rose-200 border-rose-200 dark:border-rose-800 font-bold"
                          }`}>
                      ...
                      {/* 3. الإجراءات (زر التعديل وزر الحذف) */}
                      <td className="py-3 px-4 text-center">
                        <div className="flex items-center justify-center gap-1.5">
                          ...
                          <button
                            ...
                            className="inline-flex items-center gap-1 px-2.5 py-1.5 text-xs font-semibold text-blue-700 dark:text-blue-300 bg-blue-50 dark:bg-blue-900/30 hover:bg-blue-100 dark:hover:bg-blue-900/50 rounded-lg transition-colors border border-blue-200 dark:border-blue-800"
                            title="تعديل بيانات المشترك (الصفحة، حالة الدخول، الأجهزة)"
                          >
